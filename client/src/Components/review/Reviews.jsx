                ...
                <li>
                  <figure className="relative h-full p-6 bg-white rounded-3xl">
                    ...
                    <figcaption className="relative flex items-center justify-between pt-6 mt-6 border-t border-gray-100">
                      <div>
                        <div className="text-base text-black">Annur Flint</div>
              ...
              <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
                <li>
                  <figure className="relative h-full p-6 bg-white rounded-3xl">
                    ...
                    <figcaption className="relative flex items-center justify-between pt-6 mt-6 border-t border-gray-100">
                      <div>
                        <div className="text-base text-black">Oliver Benji</div>
                        <div className="mt-1 text-sm text-gray-500">
                  ...
                  <figure className="relative h-full p-6 bg-white rounded-3xl">
                    <blockquote className="relative">
                      <p className="text-base text-gray-500">
                        ...
                        grade bonds bills management district stocks. Potential
                        funds consulting.
                      </p>
                    </blockquote>
                    <figcaption className="relative flex items-center justify-between pt-6 mt-6 border-t border-gray-100">
                      <div>
                        <div className="text-base text-black">Messi Lionel</div>
                        <div className="mt-1 text-sm text-gray-500">
                          COO at Pff Inc
                        </div>
                      </div>
                  ...
                  <figure className="relative h-full p-6 bg-white rounded-3xl">
                    <blockquote className="relative">
                      <p className="text-base text-gray-500">
                        ...
                        government 401k bear bull credit corporate bonds called
                        NYSE finance.
                      </p>
                    </blockquote>
                    <figcaption className="relative flex items-center justify-between pt-6 mt-6 border-t border-gray-100">
                      <div>
                        <div className="text-base text-black">Melon Tusk</div>
                        <div className="mt-1 text-sm text-gray-500">
                          Founder of Fesla
                        </div>
                      </div>
                  ...
                  <figure className="relative h-full p-6 bg-white rounded-3xl">
                    <blockquote className="relative">
                      <p className="text-base text-gray-500">
                        ...
                        fund expenses municipal bonds management.
                      </p>
                    </blockquote>
                    <figcaption className="relative flex items-center justify-between pt-6 mt-6 border-t border-gray-100">
                      <div>
                        <div className="text-base text-black">Målgan</div>
                        <div className="mt-1 text-sm text-gray-500">
